...
Точность решения ухудшается при выходе из интервала интегрирования [-3,3] потому что после этих значений график функции сильно растягивается - при выходе за эти границы увеличиваем допустимую погрешность.  
