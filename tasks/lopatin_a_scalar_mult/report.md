...
1. Размерность входных данных `n`, принимающее корректное только на корневом процессе, рассылается всем процессам с помощью функции `MPI_Bcast`.
