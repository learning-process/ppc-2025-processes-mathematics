...
Для каждого процесса вычисляются индексы начального и последнего столбца для обработки.
...
С помощью функции MPI\_Allreduce и параметра MPI\_MAX собирается искомый вектор максимумов.
...
| seq         | 1     | 0.0213  | 1.00    | N/A        |

| mpi         | 2     | 0.0159  | 1.34    | 67.0%      |

| mpi         | 4     | 0.0128  | 1.66    | 41.5%      |
...
Была разработана программа, которая находит максимальные значения по столбцам матрицы. Были реализованы последовательная и параллельная с помощью технологии MPI версии.
